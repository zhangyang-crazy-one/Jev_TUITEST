 ...
 * @param basePatch - Common live profile patch.
 * @param selectedPatch - Scenario live patch whose sibling supplies replay composition.
 * @param snapshotMode - Replay selects the scenario's replay sibling.
 * @param cwd - Isolated workspace containing generated patches and profile links.
 * @returns CLI arguments selecting the profile and materialized patches.
 */
