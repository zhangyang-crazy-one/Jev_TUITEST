 ...
 * @param root - Isolated raw JSONL persistence root.
 * @returns Selected parent and child logs in replay order.
 */
export async function harvestSessionLogs(root: string): Promise<HarvestedLog[]> {
  let files: string[]
  try {
